  ...
  public: {
    Tables: {
      mkt_brand_kit: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_brand_kit"]["Row"],
          "id" | "created_at" | "updated_at"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_brand_kit"]["Insert"]
        >;
      };
      mkt_brand_assets: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_brand_assets"]["Row"],
          "id" | "created_at"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_brand_assets"]["Insert"]
        >;
      };
      mkt_campaigns: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_campaigns"]["Row"],
          "id" | "created_at" | "updated_at" | "current_spend_usd"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_campaigns"]["Insert"]
        >;
      };
      mkt_projects: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_projects"]["Row"],
          | "id"
          | "created_at"
          | "updated_at"
          | "strategy_approved"
        ...
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_projects"]["Insert"]
        >;
      };
      mkt_project_versions: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_project_versions"]["Row"],
          "id" | "created_at"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_project_versions"]["Insert"]
        >;
      };
      mkt_scenes: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_scenes"]["Row"],
          "id" | "created_at" | "updated_at" | "prompt_approved"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_scenes"]["Insert"]
        >;
      };
      mkt_generations: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_generations"]["Row"],
          "id" | "created_at" | "retry_count"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_generations"]["Insert"]
        >;
      };
      mkt_captions: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_captions"]["Row"],
          "id" | "created_at" | "is_embedded"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_captions"]["Insert"]
        >;
      };
      mkt_templates: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_templates"]["Row"],
          "id" | "created_at" | "updated_at" | "use_count"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_templates"]["Insert"]
        >;
      };
      mkt_calendar_events: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_calendar_events"]["Row"],
          "id" | "created_at" | "updated_at"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_calendar_events"]["Insert"]
        >;
      };
      mkt_usage_logs: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_usage_logs"]["Row"],
          "id" | "created_at"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_usage_logs"]["Insert"]
        >;
      };
      mkt_notifications: {
        Row: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["mkt_notifications"]["Row"],
          "id" | "created_at" | "is_read"
        >;
        Update: Partial<
          Database["public"]["Tables"]["mkt_notifications"]["Insert"]
        >;
      };
    };
